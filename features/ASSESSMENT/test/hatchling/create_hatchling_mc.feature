Feature: Hatchling Item added to Question Bank
  ...
  When I submit a hatchling "multiple_choice" item
    ...
    And I verify that "assessment" system "hatchling" feature "multiple_choice_container" element does not exist
    And I verify "assessment" system "activity_editor" feature "item_title" element's "item_title_text" message is displayed on the page
