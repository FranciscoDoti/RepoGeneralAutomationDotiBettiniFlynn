...
Feature: Create a MC Hatchling Item from AMS
    ...
    Scenario: Verify that user able to create MC Hatchling Item through AMS
        ...
        And I add answers for Hatchling Multiple Choice module with following details 
            | CorrectAnswer  | IncorrectAnswer1 | IncorrectAnswer2 | IncorrectAnswer3  |
            | England        | Australia        | India            | NewZealand        |
        And I set feedback for Hatchling Multiple Choice module with following details
            | CorrectAnswerfeeback  | IncorrectAnswer1feedback | IncorrectAnswer2feedback | IncorrectAnswer3feedback |
