...
Feature: Validate the functionality of SAC Left Panel
  ...
  Scenario: Verify the question number title in nav question header and side nav title in SAC
    ...
    When I click on "1 Question" in the side nav
      Then I should see "1 of 15 Questions" as the side nav title
      And I should see "Question 1 of 15" as the nav question header
    When I click on "2 Question" in the side nav
      Then I should see "2 of 15 Questions" as the side nav title
      And I should see "Question 2 of 15" as the nav question header
    When I click on "3 Question" in the side nav
      Then I should see "3 of 15 Questions" as the side nav title
      And I should see "Question 3 of 15" as the nav question header
