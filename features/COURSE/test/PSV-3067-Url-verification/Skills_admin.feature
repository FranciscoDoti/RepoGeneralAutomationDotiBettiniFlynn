Feature: Verify that Admin is able to create URL
    ...
    Scenario: Verify that Admin is able to create a custom tsak with URL in Skills template
        ...
        And I fill out the form to update the template from draft to Template
            ...
            | edit_course_name | Skills Template Tc                                          |true |
