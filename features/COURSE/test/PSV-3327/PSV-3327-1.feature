Feature: Overview Tab verification 
  ...
  Scenario: Verify that Admin is able to add activities and assign te activities within 7 days from now 
        ...
        And I fill out the form to copy a course
            | page_object       | value                                 | clear |
            | copy_course       | Qualitative Template Testcourse       | true  |
            | copy_course_code  | E2E302                                | true  |
        And I close the popup message

        And I click on "course" system "course_list" feature "search" element "Qualitative Template Testcourse" input

        And I fill out the form to update the status of course to active
            | page_object      | value                                  | clear |
            | edit_course_name | Qualitative Template Testcourse        | true  |
            | edit_course_code |  E2E302                                | true  |
            | template_status  |  Active On Date                        |       |
        And I close the popup message
        ...
        Then I verify the activities in overview Tab
            | activity                                                          | 
