Feature: Adding activities and checking the activities are redirected to their respective pages 
    ...
    Scenario: Verify that a Media Producer is able to create a Read & Practice Course
        ...
        When I click on "course" system "courseplanner" feature "activities_link" element and reduce the activity points 
        And I click on "course" system "courseplanner" feature "assign_acitivity" element and assign the activity

        Then I verify "Assignment_status" as open
        ...
        When I login with the following credentials
            | username                                   | password         |
            | kazavogoc@hubii-network.com                |  ABCabc@123      |
        And I click on "course" system "course_list" feature "search_for_course_name" element "Edit Testcourse" input 
        And I click on "course" system "create_course" feature "course_card" element 
        And I generate access code for "Edit Testcourse"
