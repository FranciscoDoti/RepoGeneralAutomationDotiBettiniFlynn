Feature: Assigning read and practice aactivities

    @delete-all-courses
    Scenario: Verify that instructor is able to assign the activities in Read and practice Teamplate
        ...
        Then I verify the status of activities 
            ...
            | communicating courteously                                         | Open   |
