Feature: Instructor creates course from Read and Practicde template
    @delete-all-courses
    Scenario: Verify that instructor is able to create a Instructor created course from Read and Practice Template
        ...
        When I select template and create course with following details
            | page_object             |  value                  | clear |
            | copy_course             |  RndP Instructor        | true  |
            | copy_course_code        |  E2E303                 | true  |

        Then I verify that the course's name "RndP Instructor" is listed on the courses page
