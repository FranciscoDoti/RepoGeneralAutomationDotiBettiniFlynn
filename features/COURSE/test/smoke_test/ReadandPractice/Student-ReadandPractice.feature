Feature: Student attempts read and practice activity
    @delete-all-courses
    Scenario: Verify that student is able to attempt the read and practice activity
        ...
        And I attempt learning curve activity
            | activity          |
            | LC1551301608988   |
