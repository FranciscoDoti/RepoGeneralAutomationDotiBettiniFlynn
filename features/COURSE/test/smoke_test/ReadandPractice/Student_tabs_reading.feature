Feature: Tabs verification in Read and Practice course from student end

    @delete-all-courses
    Scenario: Verify that Following tabs are updating appropriately on Student End for Read & Practice Courses :-
