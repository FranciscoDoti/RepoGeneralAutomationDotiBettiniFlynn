Feature: Assigning Skills Activities

    @delete-all-courses
    Scenario: Verify that instructor is able to assign the activities in skills template
        ...
        And I assign the activities in courseplanner
            ...
            | Complete the Study Plan for Reading Strategies - English v2       | true   | 5      |  
            | Final Test for Reading Skills - Hacker                            | true   | 5      | 
 
        Then I verify the status of activities 
            | activity                                                          | verify |
            | Exercise: Misused words 1 (autoscored)                            | Open   |                                                                                             
            | LC1551301608988                                                   | Open   |
            | Complete the Study Plan for Reading Strategies - English v2       | Open   |
            | Final Test for Reading Skills - Hacker                            | Open   |
