Feature: Instructor adds custome made activity 

    @delete-all-courses
    Scenario: Verify that Instructor is able to add a custom created instructor review writing activity in an instructor created course from Writer's Help 
        ...
        When I create writing custom made activity
