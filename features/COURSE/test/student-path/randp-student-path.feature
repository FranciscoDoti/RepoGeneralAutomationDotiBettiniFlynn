Feature: Read and Practice happy path workflow student
    ...
    Scenario: Verify that Student is able to attempt activities of a Instructor created pre-made assesment course created from Read and Practice template 

        Given I have opened "courseware" "login"

        When I search for "Read and Practice_1" course
    ...
    @coureseware-logout
    Scenario: Verify that Student is able to attempt activities of a Instructor custom made assesment course created from Read and Practice Template
        Given I have opened "courseware" "login"
        
        When I have logged in as "student_2"
        And I search for "Read and Practice_1" course
        And I click on "courseware" system "course_list" feature "course_name" element
        And I click on  "courseware" system "course_page" feature "course_name" element 
    ...
    @coureseware-logout
    Scenario: Verify that Student is able to attempt activities of a Instructor that were created from Read and Practice Template
        Given I have opened "courseware" "login"
