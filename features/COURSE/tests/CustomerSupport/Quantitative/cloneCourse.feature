@Course @Smoke @API
Feature: Customer Support is able to create course from Quantitative Template
    ...
    Scenario: Verify that Customer Support is able to create course from Quantitative Template
       ...
       And I click on "COURSES" tab        
        And I copy course from the "Quantitative Course" Course with the following data
            | courseName             | courseCode           |
            | Quantitative CS Course | E2E 301              |  

        And I search for "Quantitative CS Course" in Courses tab
        
        Then I verify that "Quantitative CS Course" is created with following data
            | CourseName              | Status                    |
            | Quantitative CS Course  |  Draft                    |
