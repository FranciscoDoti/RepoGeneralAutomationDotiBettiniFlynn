   ...
   @mediaeditor-delete-course
    Scenario: Verify that media editor is able to create a template and update in Read & Practice Template
       ...
       When I create template with following data 
        ...
        And I verify that "Automation Read & Practice Template" has created with following "9781464199498" ISBN number by Media editor

       And I update "Automation Read & Practice Template" template and add the following data by Media editor
