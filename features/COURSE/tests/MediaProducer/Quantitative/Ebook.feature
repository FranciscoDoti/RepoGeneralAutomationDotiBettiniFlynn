Feature: Verify that Admin is able to add activities in Ebook
    ...
    Scenario:  Admin add activities in courseplan and not in ebook
       ...
       When I search for "Quantitative Production Template" and click on course card
       And I click on "Production" Tab
    ...
    Scenario: Verify that admin is able to delete the template 
        ...
        When I search for "Quantitative Production Template" course

        And I delete the "Quantitative Production Template"

        Then I verify that "Quantitative Production Template" is deleted
