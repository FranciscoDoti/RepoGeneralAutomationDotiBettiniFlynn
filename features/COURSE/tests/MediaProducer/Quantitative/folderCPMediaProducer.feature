@Course @Smoke
Feature: Adding activities in Folder courseplanner in Quantitaive Template

    @mediaproducer-delete-course
    Scenario: Verify that Media Producer is able to add folder in courseplanner in Quantitaive Template
