...
Feature: Adding activities in Folder courseplanner
    ...
    Scenario: Verify that Media Producer is able to add folder in courseplanner
        ...
        When I create template with following data 
           ...
           | Template    | Skills       | Skills MPF Template  |                  | E2E 367      | 9781464199405  | draft         |                      


        And I activate the "Skills MPF Template" template and add the following data
            | courseName                |  courseCode   |  templateStatus      |
            | Skills MPF Template       |   E2E 367     |  Active On Date      |

        And I add the activities in resources to "Skills MPF Template" template
            | type                     | activity                                      |
