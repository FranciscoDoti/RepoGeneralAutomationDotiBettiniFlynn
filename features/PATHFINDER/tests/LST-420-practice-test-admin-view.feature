...
# This is being fixed in LST-501.
            When I click on the "Late Penalty Confirmation Modal Cancel Button" on the instructor assignment page
                Then "PreTest Grading Settings Container" should include the text "Cumulative Late Penalty"
...
# This is being fixed in LST-501.
            When I click on the "Late Penalty Confirmation Modal Cancel Button" on the instructor assignment page
                  Then "PreTest Grading Settings Container" should include the text "No Late Penalty"
