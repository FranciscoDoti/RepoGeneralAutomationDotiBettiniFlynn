    ...
    Scenario: An admin can toggle the grading settings between performance and completion
        Given I login to Achieve-CW as "pf-admin"
            ...
            When I click on the "Grading Settings Changed Modal Ok Button" on the "instructorAssignment" page
                Then "Final Test Grading Settings Container" on the "instructorAssignment" page should include the text "Completion"
...
# return grading setting to original state
            ...
            When I click on the "Grading Settings Changed Modal Ok Button" on the "instructorAssignment" page
                Then "Final Test Grading Settings Container" on the "instructorAssignment" page should include the text "Performance"
...
# This is being fixed in LST-501.
            When I click on the "Late Penalty Confirmation Modal Cancel Button" on the "instructorAssignment" page
                Then "Final Test Grading Settings Container" on the "instructorAssignment" page should include the text "Cumulative Late Penalty"
...
# This is being fixed in LST-501.
            When I click on the "Late Penalty Confirmation Modal Cancel Button" on the "instructorAssignment" page
                  Then "Final Test Grading Settings Container" on the "instructorAssignment" page should include the text "No Late Penalty"
