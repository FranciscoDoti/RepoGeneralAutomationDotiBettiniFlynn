...
After('@admin-delete-course-and-template', async function () {
    ...
    let templateElements = await pages.courseList.getWebElements('courseNumber', course);
    ...
    await pages.courseList.populate('search', courseName);
    await pages.courseList.assertElementExists('courseNumber', course);
    let courseElements = await pages.courseList.getWebElements('courseNumber', course)
