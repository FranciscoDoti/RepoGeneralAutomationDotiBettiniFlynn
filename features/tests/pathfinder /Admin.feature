...
Background:
    ...
    @courseware-logout
    Scenario:Verify that the Admin is able to create a Course Template with Product Model being "Skills"
    ...
    @courseware-logout
    Scenario: Verify that the Admin is able to add pathfinder activities to a Course Template
        When I have logged in as "admin"
        And I search for "Pathfinder Testcourse" 
    ...
    @courseware-logout
    Scenario: Verify that Admin is able to see grade same as Instrcutor is able to see the grade
        When I have logged in as "admin"
        And I search for "Pathfinder Testcourse"
        And I click on pathfinder Test course card 
