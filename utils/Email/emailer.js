...
const config = {
    ...
    environment: (argv.env !== undefined ? argv.env : "int"),
    branch: (argv.branch !== undefined ? argv.branch : "development"),
    recepients: (argv.recepients !== undefined ? argv.recepients : "thomas.dsilva@testingconsultancy.com"),
    result: (argv.result !== undefined ? argv.result : "FAILURE")
};
